...
int main() {
    ...
    // Výraz 2, ted je a=3, b=1, c=1, d=2, e=4
    int vysledek2 = b-- * c++ + e;
    printf("Vysledek b-- * c++ + e: %d\n", vysledek2);

    // Výraz 3 ted je a=3, b=0, c=2, d=1, e=4
    int vysledek3 = -b + --c;
    printf("Vysledek -b + --c: %d\n", vysledek3);

    // Výraz 4 ted je a=3, b=0, c=1, d=1, e=4
    int vysledek4 = ++a + a--;
    printf("Vysledek ++a + a--: %d\n", vysledek4);

    // Výraz 5 ted je a=3, b=0, c=1, d=1, e=4
    if (a != 0 && --c != 0) {
    ...
    // Výraz 6 ted je a=3, b=0, c=1, d=1, e=4
    a %= b = d = 1 + e / 2;
